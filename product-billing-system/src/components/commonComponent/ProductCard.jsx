...
import LoginPromptModal from "../helperComponent/LoginPromptModal"; // ⬅️ import
...
const ProductCard = ({ product = {} }) => {
  ...
  // Local state
  const [liked, setLiked] = useState(false); // default false if no user
        ...
        <div className="p-4">
          ...
          <div className="flex items-center justify-between mt-2">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-lg font-semibold text-gray-600 min-w-[24px] text-center">
                {quantity}
              </span>
              <button
                onClick={increment}

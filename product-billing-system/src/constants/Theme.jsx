export const THEME = {
  ...
  export const THEME_CONFIG = {
    ...
    [THEME.GENERAL]: {
      BACKGROUND_COLOR: "bg-[#fafafa]",
      BACKGROUND_GRADIENT: "bg-gradient-to-br from-[#f5f5f5] to-[#e0e0e0]",
      TEXT_COLOR: "text-[#212121]",
      ACCENT: "bg-[#ff5722]",
      SECONDARY_ACCENT: "bg-[#ff7043]",
      BORDER_COLOR: "border-[#bdbdbd]",
      BUTTON: "bg-[#ff5722] text-white hover:bg-[#e64a19]",
      SHADOW: "shadow-md",

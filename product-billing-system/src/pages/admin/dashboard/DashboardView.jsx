  ...
  return (
    <div className={`w-full rounded-2xl mx-6 px-4 p-6 ₹{theme.BACKGROUND_COLOR}`}>
      ...
      <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center mb-8 p-6 bg-white rounded-2xl shadow-lg">
        <div>
          <h1 className="text-3xl font-bold bg-gradient-to-r from-purple-600 to-blue-600 bg-clip-text text-transparent">Restaurant Dashboard</h1>
        ...
        <div className="mt-4 lg:mt-0 lg:ml-auto self-end lg:self-start">
          <span className="px-3 py-1 rounded-full bg-purple-100 text-purple-700 text-sm font-medium flex items-center">

    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 to-purple-100 p-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-wrap justify-between items-center mb-8 p-6 bg-white rounded-2xl shadow-lg">
          <div>
            <h1 className="text-3xl font-bold bg-gradient-to-r from-purple-600 to-blue-600 bg-clip-text text-transparent">Categories</h1>
                ...
                >
                  <div className="relative">
                    <img
                      src={
                        ...
                        "https://images.unsplash.com/photo-1607082348824-0a96f2a4b9da?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=600&q=80"
                      }
                  ...
                  <div className="p-4 flex flex-col justify-between grow">
                    ...
                    <div className="mt-4 pt-3 border-t border-gray-100 flex justify-between items-center">
                      ...
                      <span className="text-xs px-2 py-1 bg-purple-100 text-purple-800 rounded-full">{category.status || "Active"}</span>
                    </div>
                  </div>
                </div>
              );

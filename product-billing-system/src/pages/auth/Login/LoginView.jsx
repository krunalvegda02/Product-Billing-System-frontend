        ...
        <div className="w-full max-w-md">
          ...
          <div className="bg-white rounded-2xl shadow-lg border border-stone-200 p-8">
            ...
            {/* <div className="mt-6 p-3 bg-amber-50 rounded-lg border border-amber-200">
              <p className="text-sm text-stone-700 mb-2 font-medium">Signing in as:</p>
              <div className="flex space-x-3">
                <button 
                  type="button"
                  className="flex-1 py-2 px-3 text-xs bg-white border border-amber-300 text-amber-700 rounded-md hover:bg-amber-50 transition-colors"
                >
                  Staff Member
                </button>
                <button 
                  type="button"
                  className="flex-1 py-2 px-3 text-xs bg-amber-600 text-white rounded-md hover:bg-amber-700 transition-colors"
                >
                  Administrator
                </button>
                <button 
          ...
          {/* <div className="mt-8 text-center">
            <p className="text-stone-600 text-sm mb-4">Or continue with</p>
            <div className="flex justify-center space-x-4">
              <button className="p-3 bg-white border border-stone-300 rounded-lg shadow-sm hover:shadow-md transition-all duration-200 hover:border-amber-400">

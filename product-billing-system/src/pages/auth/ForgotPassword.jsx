    ...
    <div className="grid lg:grid-cols-2  grid-cols-1  lg:h-screen overflow-hidden">
      ...
      <div className="flex items-center justify-center ">
        <div className="lg:w-3/4 w-2/3 text-center">
          ...
          <p className="mb-5 text-sm">don't worry We'll reset your Password and send you a link to create to new one</p>
          ...
          <div className="flex lg:flex-row flex-col  justify-between gap-2 ">
            ...
            className="border bg-amber-300 px-[17px] py-[4px]"> Reset Password</button>
          </div>
        </div>
      </div>
    </div>
